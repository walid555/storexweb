        ...
        <tbody>
            <template v-if="posts.length > 0">
                <tr v-for="(i, index) in posts" :key="i._id">
                    ...
                    <td class="text-end">
                        <div class="btn-group">
                            <router-link :to="{ name: 'movie-edit', params: { id: i._id } }"
                                class="btn btn-outline-success btn-sm">Edit</router-link>
                            <router-link :to="{ name: 'movie', params: { id: i._id } }"
                                class="btn btn-outline-primary btn-sm">View</router-link>
                            <router-link :to="{ name: 'movie-delete', params: { id: i._id } }" class="btn btn-outline-danger btn-sm">Del</router-link>
                        </div>
                    </td>
                </tr>
            </template>
